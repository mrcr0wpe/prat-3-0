--[[
    @File:      chatsections.lua
    @Project:   Prat-3.0

    BR: Núcleo estrutural do pipeline de mensagens do chat.
        - Separação e reconstrução de mensagens
        - Gerenciamento de hyperlinks e canais
        - Integração com filtros Blizzard
        - Manipulação estrutural de mensagens do chat

    EN: Core structural service for the chat message pipeline.
        - Message splitting and reconstruction
        - Hyperlink and channel management
        - Blizzard filter integration
        - Structural manipulation of chat messages
...
--[[------------------------------------------------
    BR: Estrutura principal da mensagem após separação.
    EN: Main message structure after splitting.
------------------------------------------------]]--
...
--[[------------------------------------------------
    BR: Reconstrói o texto completo do chat.
    EN: Rebuilds the complete chat text.
------------------------------------------------]]--
...
--[[------------------------------------------------
    BR: Registra novos componentes no pipeline do chat.
    EN: Registers new components into the chat pipeline.
------------------------------------------------]]--
...
--[[------------------------------------------------
    BR: Núcleo de separação e processamento de mensagens.
    EN: Core message splitting and processing routine.
------------------------------------------------]]--
