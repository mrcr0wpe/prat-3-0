--[[
    @File:      bayesclassifier.lua
    @Project:   Prat-3.0

    BR: Serviço de classificação estatística bayesiana.
        - Classificação de spam/ham
        - Aprendizado incremental
        - Cache probabilístico
        - Análise baseada em Bayes + Chi-Square

    EN: Bayesian statistical classification service.
        - Spam/ham classification
        - Incremental learning
        - Probability cache
        - Bayes + Chi-Square based analysis
...
--[[------------------------------------------------
    BR: Cálculo de probabilidade Chi-Square.
    EN: Chi-Square probability calculation.
------------------------------------------------]]--
